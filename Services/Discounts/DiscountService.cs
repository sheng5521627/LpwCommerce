...
using Services.Discounts.Cache;
...
namespace Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
        ...
        public IList<Discount> GetAllDiscounts(DiscountType? discountType, string couponCode = "", string discountName = "", bool showHidden = false)
        {
        ...
        public IPagedList<DiscountUsageHistory> GetAllDiscountUsageHistory(int? discountId = null, int? customerId = default(int?), int? orderId = default(int?), int pageIndex = 0, int pageSize = int.MaxValue)
        {
