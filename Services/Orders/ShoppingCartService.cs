...
namespace Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        public IList<string> GetRequiredProductWarnings(Customer customer, ShoppingCartType shoppingCartType, Product product, int storeId, bool automaticallyAddRequiredProductsIfEnabled)
        {
            if (customer == null)
        ...
        public IList<string> GetShoppingCartItemAttributeWarnings(Customer customer, ShoppingCartType shoppingCartType, Product product, 
            int quantity = 1, string attributesXml = "", bool ignoreNonCombinableAttributes = false)
        {
            if (product == null)
                throw new ArgumentNullException("product");
        ...
        public IList<string> GetRentalProductWarnings(Product product, DateTime? rentalStartDate = default(DateTime?), DateTime? rentalEndDate = default(DateTime?))
        {
            if (product == null)
                throw new ArgumentNullException("product");
        ...
        public IList<string> GetShoppingCartItemWarnings(Customer customer, ShoppingCartType shoppingCartType, Product product, int storeId, 
            string attributesXml, decimal customerEnteredPrice, DateTime? rentalStartDate = default(DateTime?), 
            DateTime? rentalEndDate = default(DateTime?), int quantity = 1, bool automaticallyAddRequiredProductsIfEnabled = true, 
        ...
        public ShoppingCartItem FindShoppingCartItemInTheCart(IList<ShoppingCartItem> shoppingCart, ShoppingCartType shoppingCartType, Product product, 
            string attributesXml = "", decimal customerEnteredPrice = 0, 
            DateTime? rentalStartDate = default(DateTime?), DateTime? rentalEndDate = default(DateTime?))
        {
        ...
        public IList<string> AddToCart(Customer customer, Product product, ShoppingCartType shoppingCartType, int storeId, 
            string attributesXml = null, decimal customerEnteredPrice = 0, 
            DateTime? rentalStartDate = default(DateTime?), DateTime? rentalEndDate = default(DateTime?), 
        ...
        public IList<string> UpdateShoppingCartItem(Customer customer, int shoppingCartItemId, string attributesXml, decimal customerEnteredPrice, DateTime? rentalStartDate = default(DateTime?), DateTime? rentalEndDate = default(DateTime?), int quantity = 1, bool resetCheckoutData = true)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
