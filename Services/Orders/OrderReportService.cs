...
namespace Services.Orders
{
    ...
    public partial class OrderReportService : IOrderReportService
    {
        ...
        public IList<OrderByCountryReportLine> GetCountryReport(int storeId = 0, OrderStatus? os = default(OrderStatus?), 
            PaymentStatus? ps = default(PaymentStatus?), ShippingStatus? ss = default(ShippingStatus?), 
            DateTime? startTimeUtc = default(DateTime?), DateTime? endTimeUtc = default(DateTime?))
        {
            ...
            var report = (from o in query
                          group o by o.BillingAddress.CountryId into result
                          select new
                          {
                              CountryId = result.Key,
                              TotalOrders = result.Count(),
                              SumOrders = result.Sum(m => m.OrderTotal)
                          }
                          )
        ...
        public OrderAverageReportLine GetOrderAverageReportLine(int storeId = 0, int vendorId = 0, int billingCountryId = 0, int orderId = 0, 
            string paymentMethodSystemName = null, OrderStatus? os = default(OrderStatus?), PaymentStatus? ps = default(PaymentStatus?), 
            ShippingStatus? ss = default(ShippingStatus?), DateTime? startTimeUtc = default(DateTime?), 
            DateTime? endTimeUtc = default(DateTime?), string billingEmail = null, string billingLastName = "",
        ...
        public IPagedList<BestsellersReportLine> BestSellersReport(int categoryId = 0, int manufacturerId = 0, int storeId = 0, int vendorId = 0, 
            ...
            ShippingStatus? ss = default(ShippingStatus?), int billingCountryId = 0, int orderBy = 1, 
        ...
        /// <returns></returns>
        public int[] GetAlsoPurchasedProductsIds(int storeId, int productId, int recordsToReturn = 5, bool showHidden = false)
        {
            if (productId == 0)
        ...
        public IPagedList<Product> ProductsNeverSold(int vendorId = 0, DateTime? createdFromUtc = default(DateTime?), DateTime? createdToUtc = default(DateTime?), int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
        ...
        /// <param name="paymentMethodSystemName"></param>
        /// <param name="os"></param>
        /// <param name="ps"></param>
        /// <param name="ss"></param>
        ...
        /// <returns></returns>
        public decimal ProfitReport(int storeId = 0, int vendorId = 0, int billingCountryId = 0, int orderId = 0, string paymentMethodSystemName = null, 
            OrderStatus? os = default(OrderStatus?), PaymentStatus? ps = default(PaymentStatus?), ShippingStatus? ss = default(ShippingStatus?), 
            DateTime? startTimeUtc = default(DateTime?), DateTime? endTimeUtc = default(DateTime?), string billingEmail = null, 
            string billingLastName = "", string orderNotes = null)
        {
            int? orderStatusId = null;
            if (os.HasValue)
                orderStatusId = (int)os.Value;
