...
namespace Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual void AwardRewardPoints(Order order)
        {
            ...
            //add reward points
            order.RewardPointsHistoryEntryId = _rewardPointService.AddRewardPointsHistoryEntryNews(order.Customer, points, order.StoreId,
            ...
            try
            {
                ...
                if (processPaymentResult.Success)
                {
                    ...
                    foreach (var sc in details.Cart)
                    {
                        ...
                        //inventory
                        _productService.AdjustInventoryNews(sc.Product, -sc.Quantity, sc.AttributesXml,
            ...
            if (order.OrderStatus != OrderStatus.Cancelled)
            {
                ...
                foreach (var shipment in order.Shipments)
                {
                    foreach (var shipmentItem in shipment.ShipmentItems)
                    {
                        ...
                        _productService.ReverseBookedInventoryNews(orderItem.Product, shipmentItem,
                ...
                foreach (var orderItem in order.OrderItems)
                {
                    _productService.AdjustInventoryNews(orderItem.Product, orderItem.Quantity, orderItem.AttributesXml,
                        string.Format(_localizationService.GetResource("Admin.StockQuantityHistory.Messages.DeleteOrder"), order.Id));
                }
