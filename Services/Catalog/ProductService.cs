...
namespace Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        public int GetCategoryProductNumber(IList<int> categoryIds = null, int storeId = 0)
        {
            ...
            if (categoryIds != null && categoryIds.Count > 0)
            {
                query = from p in query
                        from pc in p.ProductCategories.Where(m => categoryIds.Contains(m.CategoryId))
                        select p;
            }
            ...
            if (!_catalogSettings.IgnoreAcl)
            {
                ...
                query = from p in query
                        ...
                        where !p.SubjectToAcl || allowedCustomerRoleIds.Contains(acl.CustomerRoleId)
                        select p;
            }
            ...
            var result = query.Select(p => p.Id).Distinct();
            return result.Count();
        }

        public IPagedList<Product> SearchProducts(int pageIndex = 0, int pageSize = int.MaxValue, IList<int> categoryIds = null, 
            int manufacturerId = 0, int storeId = 0, int vendorId = 0, int warehouseId = 0, 
            ProductType? productType = default(ProductType?), bool visibleIndividuallyOnly = false, bool markedAsNewOnly = false,
            bool? featuredProducts = default(bool?), decimal? priceMin = default(decimal?), decimal? priceMax = default(decimal?),
            int productTagId = 0, string keywords = null, bool searchDescriptions = false, bool searchSku = true,
            bool searchProductTags = false, int languageId = 0, IList<int> filteredSpecs = null,
            ProductSortingEnum orderBy = ProductSortingEnum.Position, bool showHidden = false, bool? overridePublished = default(bool?))
        {
        ...
        public IPagedList<Product> SearchProducts(
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, IList<int> categoryIds = null, 
            int manufacturerId = 0, int storeId = 0, int vendorId = 0, int warehouseId = 0, 
            ProductType? productType = default(ProductType?), bool visibleIndividuallyOnly = false, 
            bool markedAsNewOnly = false, bool? featuredProducts = default(bool?), decimal? priceMin = default(decimal?), 
            decimal? priceMax = default(decimal?), int productTagId = 0, string keywords = null, 
            bool searchDescriptions = false, bool searchSku = true, bool searchProductTags = false, 
            int languageId = 0, IList<int> filteredSpecs = null, ProductSortingEnum orderBy = ProductSortingEnum.Position, 
            bool showHidden = false, bool? overridePublished = default(bool?))
        {
            ...
            else
            {
                ...
                //search by specs search by specs
        ...
        /// <param name="quantityToChange"></param>
