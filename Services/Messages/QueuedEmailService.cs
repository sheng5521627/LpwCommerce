...
namespace Services.Messages
{
    public partial class QueuedEmailService : IQueuedEmailService
    {
        ...
        public IPagedList<QueuedEmail> SearchEmails(string fromEmail, string toEmail, DateTime? createdFromUtc, DateTime? createdToUtc, bool loadNotSentItemsOnly, int maxSendTries, bool loadNewest, int pageIndex = 0, int pageSize = int.MaxValue)
        {
