...
namespace Web.Framework.Localization
{
    public static class LocalizedRouteExtensions
    {
        ...
        public static Route MapLocalizedRoute(this RouteCollection routes,string name,string url,object defaults,object contraints, string[] namespaces)
        {
            if (routes == null)
            {
            ...
            var route = new LocalizedRoute(url, new MvcRouteHandler())
            {
                ...
                Constraints = new RouteValueDictionary(contraints),
